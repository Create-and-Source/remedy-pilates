...
function initPhotos() {
  ...
  const sets = [
    { id: 'PHT-1', patientId: 'CLT-1000', patientName: 'Emma Johnson', serviceId: 'SVC-1', serviceName: 'Reformer', providerId: 'INS-1', angle: 'Front', phase: 'before', date: '2025-12-10', notes: 'Posture assessment — forward head, rounded shoulders', consent: true, createdAt: '2025-12-10T10:00:00Z' },
    { id: 'PHT-2', patientId: 'CLT-1000', patientName: 'Emma Johnson', serviceId: 'SVC-1', serviceName: 'Reformer', providerId: 'INS-1', angle: 'Front', phase: 'after', date: '2026-02-20', notes: 'After 10 weeks — improved spinal alignment, shoulders no longer rounding forward', consent: true, createdAt: '2026-02-20T10:00:00Z' },
    { id: 'PHT-3', patientId: 'CLT-1001', patientName: 'Olivia Williams', serviceId: 'SVC-3', serviceName: 'Barre', providerId: 'INS-2', angle: 'Right 45°', phase: 'before', date: '2025-12-15', notes: 'Tight hip flexors — limited range of motion in hip extension', consent: true, createdAt: '2025-12-15T14:00:00Z' },
    { id: 'PHT-4', patientId: 'CLT-1001', patientName: 'Olivia Williams', serviceId: 'SVC-3', serviceName: 'Barre', providerId: 'INS-2', angle: 'Right 45°', phase: 'after', date: '2026-02-25', notes: 'After 6 weeks barre — hip extension markedly improved, smoother gait pattern', consent: true, createdAt: '2026-02-25T14:00:00Z' },
    { id: 'PHT-5', patientId: 'CLT-1002', patientName: 'Sophia Brown', serviceId: 'SVC-8', serviceName: 'Private Training', providerId: 'INS-3', angle: 'Front', phase: 'before', date: '2026-01-20', notes: 'Post-partum — diastasis recti, weak pelvic floor, abdominal separation ~3cm', consent: true, createdAt: '2026-01-20T11:00:00Z' },
    { id: 'PHT-6', patientId: 'CLT-1002', patientName: 'Sophia Brown', serviceId: 'SVC-8', serviceName: 'Private Training', providerId: 'INS-3', angle: 'Front', phase: 'after', date: '2026-03-01', notes: 'Core reconnection progressing well — separation reduced, deep stabilizers activating', consent: true, createdAt: '2026-03-01T11:00:00Z' },
    { id: 'PHT-7', patientId: 'CLT-1003', patientName: 'Ava Jones', serviceId: 'SVC-5', serviceName: 'TRX Fusion', providerId: 'INS-2', angle: 'Left 45°', phase: 'before', date: '2026-01-05', notes: 'Low core engagement — compensating with lower back during most movements', consent: true, createdAt: '2026-01-05T09:00:00Z' },
    { id: 'PHT-8', patientId: 'CLT-1003', patientName: 'Ava Jones', serviceId: 'SVC-5', serviceName: 'TRX Fusion', providerId: 'INS-2', angle: 'Left 45°', phase: 'after', date: '2026-02-15', notes: 'After 6 weeks — noticeably stronger core activation, lower back no longer overloading', consent: true, createdAt: '2026-02-15T09:00:00Z' },
    { id: 'PHT-9', patientId: 'CLT-1004', patientName: 'Isabella Martinez', serviceId: 'SVC-10', serviceName: 'Group Apparatus', providerId: 'INS-1', angle: 'Left Side', phase: 'before', date: '2026-01-10', notes: 'Rounded shoulders and collapsed thoracic spine — limited ability to extend through mid-back', consent: true, createdAt: '2026-01-10T09:30:00Z' },
    { id: 'PHT-10', patientId: 'CLT-1004', patientName: 'Isabella Martinez', serviceId: 'SVC-10', serviceName: 'Group Apparatus', providerId: 'INS-1', angle: 'Left Side', phase: 'after', date: '2026-03-01', notes: 'Thoracic extension significantly improved — shoulders back, chest open, posture visibly upright', consent: true, createdAt: '2026-03-01T09:30:00Z' },
    { id: 'PHT-11', patientId: 'CLT-1005', patientName: 'Mia Garcia', serviceId: 'SVC-1', serviceName: 'Reformer', providerId: 'INS-4', angle: 'Right Side', phase: 'before', date: '2025-12-20', notes: 'Anterior pelvic tilt — hyperextended lumbar, overactive hip flexors pulling pelvis forward', consent: true, createdAt: '2025-12-20T10:00:00Z' },
    { id: 'PHT-12', patientId: 'CLT-1005', patientName: 'Mia Garcia', serviceId: 'SVC-1', serviceName: 'Reformer', providerId: 'INS-4', angle: 'Right Side', phase: 'after', date: '2026-02-28', notes: 'Pelvis now neutral at rest — lumbar curve normalized, hip flexors lengthening well', consent: true, createdAt: '2026-02-28T10:00:00Z' },
    { id: 'PHT-13', patientId: 'CLT-1006', patientName: 'Charlotte Miller', serviceId: 'SVC-2', serviceName: 'Mat Pilates', providerId: 'INS-2', angle: 'Front', phase: 'before', date: '2026-01-15', notes: 'Weak glutes and knee valgus — knees collapsing inward during single-leg movements', consent: true, createdAt: '2026-01-15T13:00:00Z' },
    { id: 'PHT-14', patientId: 'CLT-1006', patientName: 'Charlotte Miller', serviceId: 'SVC-2', serviceName: 'Mat Pilates', providerId: 'INS-2', angle: 'Front', phase: 'after', date: '2026-03-10', notes: 'Glute activation much improved — knee tracking over 2nd toe, valgus largely resolved', consent: true, createdAt: '2026-03-10T13:00:00Z' },
    { id: 'PHT-15', patientId: 'CLT-1007', patientName: 'Amelia Thompson', serviceId: 'SVC-6', serviceName: 'Reformer + Cardio', providerId: 'INS-5', angle: 'Left 45°', phase: 'before', date: '2025-11-15', notes: 'Limited spinal mobility — stiff thoracic and lumbar spine, rotational range severely restricted', consent: true, createdAt: '2025-11-15T10:00:00Z' },
    { id: 'PHT-16', patientId: 'CLT-1007', patientName: 'Amelia Thompson', serviceId: 'SVC-6', serviceName: 'Reformer + Cardio', providerId: 'INS-5', angle: 'Left 45°', phase: 'after', date: '2026-02-15', notes: 'Full range of motion restored — rotation, lateral flexion, and spinal extension all normal', consent: true, createdAt: '2026-02-15T10:00:00Z' },
  ];
